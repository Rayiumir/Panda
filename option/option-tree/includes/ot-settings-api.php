...
echo ' ';
            ...
            if ( $show_buttons ) {
              ...
              echo '<div id="option-tree-settings-api">';
                ...
                /* Sub Header */
                echo '<div id="option-tree-sub-header" style="text-align: center;"><h1>Option Site</h1>';
              ...
              if ( $show_buttons ) {
                ...
                echo '<form method="post" action="' . str_replace( '&settings-updated=true', '', $_SERVER["REQUEST_URI"] ) . '">';
                  ...
                  echo '<button type="submit" class="option-tree-ui-button button button-secondary left reset-settings" title="' . __( 'Reset Settings', 'option-tree' ) . '">' . __( 'Reset Settings', 'option-tree' ) . '</button>';
