      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( ! empty( $ids ) ) {
          ...
          <div class="ot-gallery-buttons">
            <a href="#" class="option-tree-ui-button button button-secondary hug-left ot-gallery-delete">' . __( 'حذف گالری', 'option-tree' ) . '</a>
            <a href="#" class="option-tree-ui-button button button-primary right hug-right ot-gallery-edit">' . __( 'ویرایش گالری', 'option-tree' ) . '</a>
          </div>';
          ...
          echo '
          <div class="ot-gallery-buttons">
            <a href="#" class="option-tree-ui-button button button-primary right hug-right ot-gallery-edit">' . __( 'ایجاد گالری عکس', 'option-tree' ) . '</a>
          </div>';
      ...
      echo '<div class="format-setting-inner">';
        ...
        $field_choices = array(
          array(
             ...
             */
            'label'   => apply_filters( 'ot_on_off_switch_on_label', 'ON', $field_id, 'on' )
          ),
          array(
            /**
             ...
             * @param string $filter_id For filtering both on/off label with one function.
             */
            'label'   => apply_filters( 'ot_on_off_switch_off_label', 'OFF', $field_id, 'off' )
          )
        );
